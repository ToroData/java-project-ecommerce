...
public class OrderTest {
    ...
    public void testConstructor() {
        ...
        LocalDate d = LocalDate.of(2023, 4, 19);
...
//            fail("There was something wrong with testRemoveOrderItem");
    ...
    public void testCompareTo(){
        System.out.println("order1 - OrderDate: " + order1.getOrderDate() + ", TotalPrice: " + order1.getTotalPrice());
        System.out.println("order2 - OrderDate: " + order2.getOrderDate() + ", TotalPrice: " + order2.getTotalPrice());
    ...
    void checkUserFieldsSanity() {
        ...
        assertEquals(7, Order.class.getDeclaredFields().length);
        try {
            ...
            assertTrue(Modifier.isPrivate(Order.class.getDeclaredField("itemCount").getModifiers()));
